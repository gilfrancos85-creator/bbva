...
const mobileNavItems = [
  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        <path d="M2 8.5h20M6 12h2m4 0h2M6 15.5h2M4 5h16a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V6a1 1 0 011-1z"
          stroke={active ? "var(--accent)" : "currentColor"}
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="dashboard-layout" style={{ display: "flex", minHeight: "100vh", background: "var(--bg)" }}>
      ...
      {/* Contenu principal */}
      <main className="dashboard-main" style={{ flex: 1, overflow: "auto", padding: "32px" }}>
        {children}
      </main>
